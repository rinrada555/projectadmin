            ...
            <div class="container-fluid">
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('appointments') }}">รอการอนุมัติ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('approved') }}">อนุมัติแล้ว</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('delete') }}">ยกเลิกการนัด</a>
                        </li>
                    </ul>
                </div>
                <br>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{ route('appointments.show', $appointment->id) }}" type="button" class="btn btn-secondary">รายละเอียด</a>
                                            <a href="" type="button" class="btn btn-warning"><i class="fas fa-pencil"></i> แก้ไข</a>
